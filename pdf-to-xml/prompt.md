...
- CRITICAL: Underline does NOT stop at sentence boundaries. A single underlined passage can contain multiple sentences. If you see "word1. Word2 word3" and the underline line runs beneath ALL of it, then ALL of it goes in one `<underline>` tag: `<underline>word1. Word2 word3</underline>`. Do NOT split at the period. The ONLY thing that determines boundaries is the visual line drawn beneath the text.
